...
| **Hangar facility** (surface or drydock) | A player-owned hangar facility in the city (surface — MS, MA, small craft) or at an orbital POI (drydock — capital ships). State-owned hangars accept rentals as the early-game escape valve. | Hangar manager (a hired NPC, the verb surface for everything fleet-resting); hangar workers do repair / resupply throughput; pilots stand near their assigned MS | Walk up to an MS → retrofit panel; walk up to a pilot → reassign / talk; walk up to the manager → receive-delivery, repair-priority, refit, assemble, scrap. The hangar is the diegetic home of fleet inventory — see [facilities-and-ownership.md](facilities-and-ownership.md#hangar-facility-phase-62). |
...
| **6.2** | Hangar facility class lands as a real ownable + rentable facility (surface tier in cities, drydock tier at orbital POIs); hangar manager owns receive-delivery, repair-priority, scrap. State-owned hangars at major POIs as the early-game rental escape valve. On-ship hangar deck is the *sortie loadout* surface — MS at rest live in the hangar facility, not aboard. |
