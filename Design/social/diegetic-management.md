...
| **On-ship hangar deck** (per ship) | The walkable hangar of a ship that has `hangarCapacity > 0` | The deck is the *sortie loadout surface*, not storage — MS at rest live in a hangar facility, not aboard | Pull-from-surface-hangar, unload-back-to-surface — the pre-deployment loadout decision. No retrofit / repair verbs here; those live at the hangar facility. |
