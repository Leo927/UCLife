...
- **Full pilot roster panel** at the captain's-office desk. The existing MS retrofit panel's reassign-pilot verb + the receive-MS-delivery auto-assign already cover the smoke surface; the roster panel is a UX polish layer over the same trait data.
