...
type ActionableInteractableKind = Exclude<InteractableKind, 'shop' | 'hr' | 'manager' | 'aeReception' | 'clinic' | 'pharmacy' | 'transit' | 'ticketCounter' | 'buyShip' | 'boardShip' | 'disembarkShip' | 'helm'>
