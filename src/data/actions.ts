...
type ActionableInteractableKind = Exclude<InteractableKind, 'transit' | 'ticketCounter' | 'orbitalLift' | 'boardShip' | 'inspectShip' | 'disembarkShip' | 'helm' | 'manage' | 'captainsDesk' | 'commPanel' | 'brig' | 'warRoom' | 'climbIntoMs' | 'gateTerminal'>
