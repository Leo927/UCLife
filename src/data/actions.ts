...
type ActionableInteractableKind = Exclude<InteractableKind, 'transit' | 'ticketCounter' | 'orbitalLift' | 'boardShip' | 'disembarkShip' | 'helm' | 'manage' | 'captainsDesk' | 'commPanel' | 'brig' | 'climbIntoMs'>
