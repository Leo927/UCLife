...
App.Art.isWebglArtDisplayed = function() {
	return (V.seeImages > 0 && !V.seeCustomImagesOnly && V.imageChoice === 4 && App.Art.webglErrorMessage == "Success")
}
...
App.Art.webglInitialize = function() {
	...
	load.onload = function() {
		App.Art.outfitBundles = App.Art.getOutfitBundlesData();

		// but only if version is correct
		if (App.Art.version === "2.1.1") {
